    ...
    <section id="about" className="py-20 md:py-28">
      <div className="container-ww">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold leading-[1.15] text-primary">
            A digital agency for businesses that run on leads and conversations.
          </h2>
          <p className="mt-6 text-base md:text-lg leading-relaxed text-secondary">
